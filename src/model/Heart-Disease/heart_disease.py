...
# load the data
data = pd.read_csv("E:\personal project\Onsite-Health-Diagnostic-OHD-circleci-main\src\model\Heart-Disease\heart.csv")
...
# save the model
heart_file = 'heart_failure_model.pkl'
# joblib.dump(mdl, heart_file)
joblib.dump(mdl, 'heart_failure_model.pkl')
